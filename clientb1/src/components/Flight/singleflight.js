...
export function Singleflight(){
    ...
    useEffect(() => {
        fetch(`http://localhost:2205/singleflight/${lid}/${transtype}/${tid}`)
            .then(res => res.json())
            .then((data) => {
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
                    ...
                    <h2 class="flightname text-primary">Name:{transname}</h2>
                             ...
                             <h2 class="flightdestination">Arrival:{transarrivaltime}</h2>                       

                             <h2 class="flightdestination">Departure:{transdeparturetime}</h2>                       
                             ...
                             <h2 class="flightdestination">{transclass }</h2>                       
