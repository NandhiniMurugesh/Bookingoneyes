    ...
    function updhotel(event) {
       ...
       var hotelbedtype = document.getElementById("hotelbedtype").value;
        ...
        if (hotelname == "") {
            ...
            axios.put("http://localhost:2205/updatehotel/"+hid ,key)
                .then((updhot) => {
                    if (updhot.data.status === 'error') {
                        alert(updhotel)
                    ...
                    else if (updhot.data.status === 'success') {
        ...
        <>
            <div className="addhotelpage">
                <div className="addhotel container text-center w-75 p-5">
                    <form onSubmit={updhotel} className="needs-validation">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" onChange={(upd) => setHotelname(upd.target.value)} 
                            value={hotelname}  id="hotelname" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelroom" className="form-label">
                                Enter the Hotel room
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelroom(upd.target.value)} 
                            value={hotelroom}  id="hotelroom" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelroomtype" className="form-label">
                                Enter the Hotel Roomtype
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelroomtype(upd.target.value)} 
                            value={hotelroomtype}  id="hotelroomtype" required />
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control"  onChange={(upd) => setHotelimage1(upd.target.value)} 
                            value={hotelimage1}  id="hotelimage1" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelimage2" className="form-label">
                                Enter the Hotel Image 2 URL
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelimage2(upd.target.value)} 
                            value={hotelimage2}  id="hotelimage2" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelimage3" className="form-label">
                                Enter the Hotel Image 3 URL
                            </label>
                            <input type="text" className="form-control" onChange={(upd) => setHotelimage3(upd.target.value)} 
                            value={hotelimage3}  id="hotelimage3" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hoteloriginalprice" className="form-label">
                                Enter the Hotel Original Price
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHoteloriginalprice(upd.target.value)} 
                            value={hoteloriginalprice}  id="hoteloriginalprice" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hoteldiscprice" className="form-label">
                                Enter the Hotel Discount price
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHoteldiscprice(upd.target.value)} 
                            value={hoteldiscprice}  id="hoteldiscprice" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelamenities1" className="form-label">
                                Enter the Hotel Amenities 1
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelamenities1(upd.target.value)} 
                            value={hotelamenities1}  id="hotelamenities1" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelamenities2" className="form-label">
                                Enter the Hotel Amenities 2
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelamenities2(upd.target.value)} 
                            value={hotelamenities2}  id="hotelamenities2" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelamenities3" className="form-label">
                                Enter the Hotel Amenities3
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelamenities3(upd.target.value)} 
                            value={hotelamenities3}  id="hotelamenities3" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelrating" className="form-label">
                                Enter the Hotel Rating
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelrating(upd.target.value)} 
                            value={hotelrating}  id="hotelrating" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelreview1" className="form-label">
                                Enter the Hotel Review1
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelreview1(upd.target.value)} 
                            value={hotelreview1}  id="hotelreview1" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelreview2" className="form-label">
                                Enter the Hotel Review2
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelreview2(upd.target.value)} 
                            value={hotelreview2}  id="hotelreview2" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelreview3" className="form-label">
                                Enter the Hotel Review3
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelreview3(upd.target.value)} 
                            value={hotelreview3}  id="hotelreview3" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hotelbedtype" className="form-label">
                                Enter the Hotel Bed type
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHotelbedtype(upd.target.value)} 
                            value={hotelbedtype}  id="hotelbedtype" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="hoteldistance" className="form-label">
                                Enter the Hotel Distance
                            </label>
                            <input type="text" className="form-control"  onChange={(upd) => setHoteldistance(upd.target.value)} 
                            value={hoteldistance} id="hoteldistance" required />
                        </div>
